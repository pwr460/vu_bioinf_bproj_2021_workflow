...
if __name__ == '__main__':
    ...
    parser.add_argument("-folder", "--folder", help="Folder containing all training content")
    parser.add_argument("-train", "--trainlist", help="List of train files")
    parser.add_argument("-val", "--vallist", help="List of validation files")
    parser.add_argument("-test", "--testlist", help="List of test files")
    parser.add_argument("-in", "--inputsfolder", help="Folder containing input files")
    parser.add_argument("-labels", "--labelsfolder", help="Folder containing label files")
    ...
    train_list_path = r'{}'.format(os.path.join(input_folder, args.trainlist))
    val_list_path = r'{}'.format(os.path.join(input_folder, args.vallist))
    test_list_path = r'{}'.format(os.path.join(input_folder, args.testlist))

    inputs_files_path = r'{}'.format(os.path.join(input_folder, args.inputsfolder))
    labels_files_path = r'{}'.format(os.path.join(input_folder, args.labelsfolder))
